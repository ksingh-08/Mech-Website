...
const features = [
  ...
  { title: "Distinguised Faculty", description: "Practical exposure through real-world projects that bridge the gap between theoretical knowledge and hands-on industry experience.", Icon: <FaTools /> },
];
